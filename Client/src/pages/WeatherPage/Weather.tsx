...
export const WeatherForecast = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-gray-50 p-4 mt-14">
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        <div>
          ...
          <div className="flex gap-3 mb-10">
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white border-green-600 p-3 w-48 rounded-lg"
            >
              Search
            </button>
          </div>
            ...
            <div className="animate-in fade-in zoom-in-95 duration-500">
              <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-green-100 hover:border-green-200 transition-all duration-300">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white border-2 border-cyan-100 rounded-xl p-5">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-gray-600 text-sm font-semibold uppercase tracking-wide">
                        Wind Speed
                      </span>
